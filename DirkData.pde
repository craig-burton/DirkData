...
void setup() {
  games = readGameTable("tables/dirk98-99.csv",true);
  games.addAll(readGameTable("tables/dirk99-00.csv",true));
  games.addAll(readGameTable("tables/dirk00-01.csv",true));
  games.addAll(readGameTable("tables/dirk01-02.csv",true));
  games.addAll(readGameTable("tables/dirk02-03.csv",true));
  games.addAll(readGameTable("tables/dirk03-04.csv",true));
  games.addAll(readGameTable("tables/dirk04-05.csv",true));
  games.addAll(readGameTable("tables/dirk05-06.csv",true));
  games.addAll(readGameTable("tables/dirk06-07.csv",true));
  games.addAll(readGameTable("tables/dirk07-08.csv",true));
  games.addAll(readGameTable("tables/dirk08-09.csv",true));
  games.addAll(readGameTable("tables/dirk09-10.csv",true));
  games.addAll(readGameTable("tables/dirk10-11.csv",true));
  games.addAll(readGameTable("tables/dirk11-12.csv",true));
  games.addAll(readGameTable("tables/dirk12-13.csv",true));
  games.addAll(readGameTable("tables/dirk13-14.csv",true));
  games.addAll(readGameTable("tables/dirk14-15.csv",true));
  games.addAll(readGameTable("tables/dirk15-16.csv",true));
  games.addAll(readGameTable("tables/dirk16-17.csv",true));
  size(1300,700);
  modeCount = 0;
  mode = Mode.INTRO;
  first = true;
